  ...
  return (
    <section className={styles.social}>
      ...
      <div className={styles.social_grid}>
        <div className={styles.social_card} style={{ backgroundImage: `url(${Social1})` }} >
          <div className={styles.social_card_content}>
            ...
            <div className={styles.social_card_hour_location}>
              <img src={LocationIcon} alt="icone de gps" /><p className='b3'>Salvador - BA</p>
              <img src={ClockIcon} alt="icone de relógio" /><p className='b3'>07:00</p>
            </div>
            <h6>Limpeza no lar de idosos.</h6>
            <a href="#" className='b3'>Participe</a>
          </div>
        </div>
        <div className={styles.social_card} style={{ backgroundImage: `url(${Social2})` }} >
          <div className={styles.social_card_content}>
            <div className={styles.social_card_data}>
            ...
            <div className={styles.social_card_hour_location}>
              <img src={LocationIcon} alt="icone de gps" /><p className='b3'>Aracaju - SE</p>
              <img src={ClockIcon} alt="icone de relógio" /><p className='b3'>17:00</p>
            </div>
            <h6>Entrega de mantimentos para moradores de rua.</h6>
            <a href="#" className='b3'>Participe</a>
          </div>
        </div>
        <div className={styles.social_card} style={{ backgroundImage: `url(${Social3})` }} >
          <div className={styles.social_card_content}>
            <div className={styles.social_card_data}>
            ...
            <div className={styles.social_card_hour_location}>
              <img src={LocationIcon} alt="icone de gps" /><p className='b3'>Recife - PE</p>
              <img src={ClockIcon} alt="icone de relógio" /><p className='b3'>08:00</p>
            </div>
