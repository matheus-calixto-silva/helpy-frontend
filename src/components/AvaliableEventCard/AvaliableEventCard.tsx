...
const AvaliableEventCard = ({ event }: { event: Event }) => {
  ...
  return (
    <div className={styles.social_card} style={{ backgroundImage: `url(http://localhost:3001/uploads/${event.eventPic})` }} >
      <div className={styles.social_card_content}>
        ...
        <div className={styles.social_card_hour_location}>
          <img src={LocationIcon} alt="icone de gps" /><p className='b3'>{event.address.city} - {event.address.uf}</p>
